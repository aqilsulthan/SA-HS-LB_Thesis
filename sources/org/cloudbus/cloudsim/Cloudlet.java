...
public class Cloudlet {
	...
	public Cloudlet(
		...
		this.startTime = 0.0;  // Default start time is 0
        this.waitTime = 0.0;   // Default wait time is 0
	}
	...
	public void setStartTime(final double start) {
		this.startTime = start;
	}
	
	public void setWaitTime(final double time) {
		this.waitTime = time;
	}
